      ...
      for (var action in actionItem['actions']) {
        ...
        if (actionName.toLowerCase().contains("fly")) {
          ...
          if (parameters.length > 1) {
            ...
            // If waypointData contains a symbol, resolve it
            ...
            // If waypointData contains real lat/lon values, use them directly
              ...
              var lat = waypointData['real_atom'][0]['numerator'].toDouble() /
                  waypointData['real_atom'][0]['denominator'].toDouble();
              var lon = parameters[2]['real_atom'][0]['numerator'].toDouble() /
                  parameters[2]['real_atom'][0]['denominator'].toDouble();
              waypoints.add({
                "action_name": actionName,
